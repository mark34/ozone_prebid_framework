...
- (void)ozoneSetImpAdUnitCodeWithCode:(NSString * _Nonnull)code;
- (NSString * _Nonnull)ozoneGetImpAdUnitCode SWIFT_WARN_UNUSED_RESULT;
/// set imp[].ext.ozone.customData
- (void)ozoneSetCustomDataTargetingWithData:(NSDictionary * _Nonnull)data;
- (NSDictionary * _Nonnull)ozoneGetCustomDataTargeting SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, copy) NSString * _Nonnull ozoneAdUnitCode;
@property (nonatomic, copy) NSDictionary * _Nullable ozoneCustomDataTargeting;
@property (nonatomic, copy) NSString * _Nonnull ozoneTransactionId;
...
- (void)ozoneSetAppPageWithUrl:(NSString * _Nonnull)url;
/// set device.ip
- (void)ozoneSetDeviceIpWithIp:(NSString * _Nonnull)ip;
/// Set the entire ext.ozone object at once
- (void)ozoneSetExtOzoneWithData:(NSDictionary * _Nonnull)data;
/// call this if you want to allow the code to insert the default ext.prebid object
- (void)ozoneIncludeExtPrebid;
@property (nonatomic, copy) NSDictionary * _Nonnull extOzoneDict;
@property (nonatomic) BOOL doInsertExtPrebid;
@property (nonatomic, copy) NSString * _Nullable ozoneAppPage;
